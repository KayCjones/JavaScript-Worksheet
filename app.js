...
//             // OR return (el.cuisine === "Vegetarian")
//         }
//     );
...
//     let userInput = prompt(`Please enter a selection of dish from Italian, Mexican, Hungarian, Vegetarian, French, Irish`)
//     let results = dishes.filter(
//         function(el){
...
// let userInput = prompt(`Type one of the ingredients listed: tomato, corn, cheese, beef, cabbage, chickpea, parsley, ginger, flour, sugar`)
...
//         function(prevEl, nextEl){
//             return prevEl.servings + nextEl.servings;
//         }
//     );
//     return results;
// }

// console.log(bonusTwelve());
